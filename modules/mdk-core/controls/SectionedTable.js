...
var SectionedTable = (function (_super) {
    ...
    SectionedTable.prototype.initialize = function (controlData) {
        ...
        this.setView(new mdk_sap_1.SectionedTableBridge(this.page(), this));
        this.observable();
        this._createSection();
    };
    SectionedTable.prototype.onDataChanged = function (action, result) {
        if (this.context.readLink && result && typeof (result) === 'string') {
            ...
            if (this.context.readLink === EvaluateTarget_1.asReadLink(parsedResult)) {
                this.context.binding = parsedResult;
            }
        }
        for (var _i = 0, _a = this._sections; _i < _a.length; _i++) {
            var section_2 = _a[_i];
            section_2.observable().onDataChanged(action, result);
        }
    };
