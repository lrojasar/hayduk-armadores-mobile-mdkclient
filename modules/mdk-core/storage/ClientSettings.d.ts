...
export declare class ClientSettings {
    ...
    private static readonly DEFAULT_WHITELIST_DOMAINS;
    private static readonly WHITELIST_SETTINGS;
    ...
    static setConnecionInfoToastMessage(queryStr: string): void;
    static processConnectionSettingsFromLaunchURL(queryStr: string): void;
    private static parseJsonQRResult;
    private static isWhiteListedConnectionSettings;
    ...
    private static isWhitelistedConnectionSetting;
    ...
    private static getURLWhitelist;
    private static getAppSchemeURLWhitelist;
