...
var ValueResolver = (function () {
    ...
    ValueResolver._resolveValue = function (sValue, context, recursive, excludedTypes, style) {
        ...
        else if (PropertyTypeChecker_1.PropertyTypeChecker.isFontIcon(sValue) && !this._isInExcludedTypes(excludedTypes, ValueType.FontIcon)) {
    ...
    ValueResolver._parseImage = function (value) {
        try {
            return IDefinitionProvider_1.IDefinitionProvider.instance().getDefinition(value);
        }
        catch (e) {
