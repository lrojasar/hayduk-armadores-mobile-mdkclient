...
var EventHandler = (function () {
    ...
    EventHandler.prototype.executeAction = function (sActionPath) {
        var _this = this;
        return this._resolveHandler(sActionPath).then(function (handler) {
            if (handler instanceof BaseActionDefinition_1.BaseActionDefinition) {
                return _this._executeAction(handler);
            }
            return Promise.reject("Invalid call to EventHandler.executeAction " + sActionPath + " is not an action");
        });
    };
    ...
    EventHandler.prototype.executeActionOrRule = function (sActionOrRulePath, context) {
        var _this = this;
        return this._resolveHandler(sActionOrRulePath).then(function (handler) {
            if (handler instanceof BaseActionDefinition_1.BaseActionDefinition) {
                return _this._executeAction(handler);
            }
