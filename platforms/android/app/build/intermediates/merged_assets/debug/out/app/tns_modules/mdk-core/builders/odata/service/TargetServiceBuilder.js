...
var TargetServiceBuilder = (function () {
    ...
    TargetServiceBuilder.prototype.headers = function (headers) {
        this._headers = this.getCombinedHeaders(headers);
        return this;
    };
    ...
    TargetServiceBuilder.prototype.getCombinedHeaders = function (headers) {
        var newHeaders = {};
        var serviceHeaders = IDataService_1.IDataService.instance().getServiceHeaders(this._serviceName);
        if (serviceHeaders) {
            Object.assign(newHeaders, serviceHeaders);
        }
        if (headers) {
