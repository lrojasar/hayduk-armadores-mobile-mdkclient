...
var ODataService = (function (_super) {
    ...
    ODataService.prototype.createService = function (serviceUrl, online, csdlOptions, serviceOptions) {
        if (online === void 0) { online = true; }
        return this._oDataBridge.createService({ serviceUrl: serviceUrl, online: online, csdlOptions: csdlOptions, serviceOptions: serviceOptions });
    };
    ...
    ODataService.prototype.initializeOfflineStore = function (params) {
        var _this = this;
    ...
    ODataService.prototype._adjustedServiceForRead = function (service) {
        ...
        if ((!queryOptions || startIndex === -1) && readService.properties) {
        ...
        else if ((queryOptions && startIndex !== -1) && readService.properties) {
