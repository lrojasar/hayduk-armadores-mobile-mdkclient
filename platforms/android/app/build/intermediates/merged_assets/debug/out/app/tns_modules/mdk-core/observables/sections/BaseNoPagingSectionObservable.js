    ...
    BaseNoPagingSectionObservable.prototype._resolveData = function (definition) {
        ...
        if (definition.data.Target) {
            ...
            if (PropertyTypeChecker_1.PropertyTypeChecker.isTargetPath(targetDefinition) ||
                ...
                var origQuery_1 = definition.data.Target.QueryOptions;
                return EvaluateTarget_1.asService(definition.data, this.section.context).then(function (service) {
                    definition.data.Target.QueryOptions = origQuery_1;
