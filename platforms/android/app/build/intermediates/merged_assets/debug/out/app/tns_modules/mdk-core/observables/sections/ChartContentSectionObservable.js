...
var ChartContentSectionObservable = (function (_super) {
    ...
    ChartContentSectionObservable.prototype._resolveData = function (definition) {
        var _this = this;
        if (definition.data.ChartContent.Target) {
            var targetDefinition = definition.data.ChartContent.Target;
            if (PropertyTypeChecker_1.PropertyTypeChecker.isTargetPath(targetDefinition) ||
                ...
                return EvaluateTarget_1.asService(definition.data.ChartContent, this.section.context).then(function (service) {
