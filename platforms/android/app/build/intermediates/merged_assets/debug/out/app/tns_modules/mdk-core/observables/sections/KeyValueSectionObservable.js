    ...
    KeyValueSectionObservable.prototype.bind = function () {
        ...
        if (definition.data.Target) {
            ...
            if (PropertyTypeChecker_1.PropertyTypeChecker.isTargetPath(targetDefinition) ||
                ...
                targetPromise = ValueResolver_1.ValueResolver.resolveValue(targetDefinition, this.section.context, false).then(function (data) {
                ...
                targetPromise = EvaluateTarget_1.asService(definition.data, this.section.context).then(function (service) {
