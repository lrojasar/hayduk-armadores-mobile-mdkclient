...
var DefaultLogger = (function (_super) {
    ...
    DefaultLogger.APPUPDATE_SUCCESSFULLY_APPLY_SDK_STYLES = "succesfully applied SDK styles from application path '{0}'";
    DefaultLogger.APPUPDATE_SUCCESSFULLY_APPLY_STYLES = "succesfully applied styles from application path '{0}'";
    ...
    DefaultLogger.STARTUP_SUCCEED_APPLY_STYLES = "succesfully applied styles from application path '{0}'";
