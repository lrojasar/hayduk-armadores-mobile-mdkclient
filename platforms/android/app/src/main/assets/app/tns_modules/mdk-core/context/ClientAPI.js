...
var ClientAPI = (function () {
    ...
    ClientAPI.prototype.read = function (serviceName, entitySet, properties, queryOptions, headers, requestOptions) {
        ...
        var unresolvedHeaders = { 'Headers': target.headers };
        return EvaluateTarget_1.asHeaders(unresolvedHeaders, this._context).then(function (resolvedHeaders) {
    ...
    ClientAPI.prototype.setRegion = function (region) {
        if (typeof region !== 'string' || region === '' || region === undefined) {
            ...
            if (i18nRegions) {
                ...
                throw new Error(ErrorMessage_1.ErrorMessage.FAILED_GET_REGIONS);
            }
        }
    };
    ...
    ClientAPI.prototype.sendRequest = function (path, params) {
        ...
        return mdk_sap_1.CpmsSession.getInstance().sendRequest(url, params);
    };
...
var FormCellTargetProxy = (function () {
    function FormCellTargetProxy(specifier) {
        this._serverSidePaging = false;
        this._specifier = specifier;
        this._displayValue = this._specifier.DisplayValue;
        this._returnValue = this._specifier.ReturnValue;
    ...
    FormCellTargetProxy.prototype.getEntitySet = function () {
        return this._entitySet;
    };
    FormCellTargetProxy.prototype.getFunction = function () {
        return this._function;
    };
    FormCellTargetProxy.prototype.getQueryOptions = function () {
        return this._queryOptions;
    };
    FormCellTargetProxy.prototype.getReturnValue = function () {
        return this._returnValue;
    };
    FormCellTargetProxy.prototype.getServerSidePaging = function () {
        return this._serverSidePaging;
    };
    FormCellTargetProxy.prototype.getService = function () {
    ...
    FormCellTargetProxy.prototype.setEntitySet = function (value) {
        this._entitySet = value;
        return this;
    };
    FormCellTargetProxy.prototype.setFunction = function (value) {
        if (typeof (value) === 'object' && value.hasOwnProperty('Name')) {
            this._function = value;
        }
        return this;
    };
    FormCellTargetProxy.prototype.setQueryOptions = function (value) {
    ...
    FormCellTargetProxy.prototype.setServerSidePaging = function (value) {
        this._serverSidePaging = value;
        return this;
    };
    FormCellTargetProxy.prototype.setService = function (value) {
        this._service = value;
        return this;
    };
    ...
    PageProxy.prototype.setActionBarItemVisible = function (item, visibleFlag) {
        ...
        if (item >= 0 && item < items.length) {
            if (application.android) {
                if ((item === 0) && this._page.isModal() && this._page.actionBar.navigationButton) {
                    ...
                    for (var _i = 0, items_1 = items; _i < items_1.length; _i++) {
                        ...
                        if (actionBarItem.orgIndex === item) {
                ...
                items[item].visibility = visibleFlag ? 'visible' : 'collapse';
            }
        }
    };
