...
var AnalyticCardCollectionSectionObservable = (function (_super) {
    ...
    AnalyticCardCollectionSectionObservable.prototype._resolveData = function (cardDefinition) {
        var _this = this;
        if (cardDefinition.Target) {
            var targetDefinition = cardDefinition.Target;
            if (PropertyTypeChecker_1.PropertyTypeChecker.isRule(targetDefinition) ||
                PropertyTypeChecker_1.PropertyTypeChecker.isTargetPath(targetDefinition) ||
                ...
                var origQuery_1 = cardDefinition.Target.QueryOptions;
                return EvaluateTarget_1.asService(cardDefinition, this.section.context).then(function (service) {
                    cardDefinition.Target.QueryOptions = origQuery_1;
