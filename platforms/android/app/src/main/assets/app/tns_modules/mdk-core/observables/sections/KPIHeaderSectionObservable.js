...
var KPIHeaderSectionObservable = (function (_super) {
    ...
    KPIHeaderSectionObservable.prototype.bind = function () {
        ...
        var promises = [];
        var kpiPromises = [];
        Object.keys(KPIHeader).forEach(function (key) {
            switch (key) {
                case KPIHeaderSectionObservable._kpiItemsKey:
                    promises.push(new Promise(function (resolve) {
                        var properties = {};
                        properties[key] = {};
                        var kpiHeaderValue = KPIHeader[key];
                ...
                case KPIHeaderSectionObservable._stylesKey:
                    ...
                    promises.push(ValueResolver_1.ValueResolver.resolveValue(KPIHeader[key], oContext).then(function (styles) {
                        var properties = {};
                        properties[key] = {};
                        var stylePromises = [];
