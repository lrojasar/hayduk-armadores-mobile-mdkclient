...
var ProfileHeaderSectionObservable = (function (_super) {
    ...
    ProfileHeaderSectionObservable.prototype._resolveData = function (definition) {
        var _this = this;
        if (definition.data.ProfileHeader.Target) {
            var targetDefinition = definition.data.ProfileHeader.Target;
            if (PropertyTypeChecker_1.PropertyTypeChecker.isTargetPath(targetDefinition) ||
                ...
                return EvaluateTarget_1.asService(definition.data.ProfileHeader, this.section.context).then(function (service) {
