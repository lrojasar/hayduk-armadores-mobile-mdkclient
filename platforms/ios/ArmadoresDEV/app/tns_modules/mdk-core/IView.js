...
var IView = (function () {
    ...
    IView.prototype.executeAction = function (sActionOrRulePath) {
        ...
        return oEventHandler.executeActionOrRule(sActionOrRulePath, this.context);
    };
    IView.prototype.executeActionOrRule = function (sActionOrRulePath) {
        var oEventHandler = new EventHandler_1.EventHandler();
        if (this.context.clientAPIProps && this.context.clientAPIProps.eventSource) {
            oEventHandler.setEventSource(this.context.clientAPIProps.eventSource);
        }
