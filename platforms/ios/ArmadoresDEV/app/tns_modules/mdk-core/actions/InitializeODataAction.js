    ...
    InitializeODataAction.prototype.execute = function () {
        ...
        return builder.build().then(function (params) {
            ...
            sbuilder.setOfflineCsdlOptions(serviceDefinition.offlineCsdlOptions)
                ...
                .setHeaders(unresolvedServiceHeaders);
            return sbuilder.build().then(function (sparams) {
                ...
                if (DataServiceDefinition_1.DataServiceDefinition.isOffline(sparams.offlineEnabled)) {
                    ...
                    serviceHeaders = sparams.headers;
                    var offlineServiceHeaders_1 = _this.formatServiceHeaders(sparams.headers);
                    return EvaluateTarget_1.asDefiningRequests(_this.definition.data, _this.context()).then(function (definingRequests) {
                        return IDataService_1.IDataService.instance().initializeOfflineStore({
                            ...
                            offlineServiceHeaders: offlineServiceHeaders_1
                        }).then(function (data) {
                    ...
                    var isOnline = true;
                    return IDataService_1.IDataService.instance().createService(serviceUrl, isOnline, sparams.csdlOptions, sparams.serviceOptions).then(function () {
                        return IDataService_1.IDataService.instance().openService({ serviceUrl: serviceUrl, serviceHeaders: serviceHeaders }).then(function (data) {
