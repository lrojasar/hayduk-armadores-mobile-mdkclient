...
var ExtensionBuilder = (function () {
    ...
    ExtensionBuilder.prototype.createExtension = function () {
        ...
        var extSource = ExtensionControlSource_1.ExtensionControlSource.Metadata;
        ...
        if (!extModule) {
            modPath = this._getPartialExtensionModulePath();
            if (app.ios || app.android) {
                extModule = RequireUtil_1.RequireUtil.require('./extensions/' + modPath);
                extSource = ExtensionControlSource_1.ExtensionControlSource.Extension;
            }
        }
        if (extModule) {
        ...
        if (!extClass) {
            throw new Error(ErrorMessage_1.ErrorMessage.format(ErrorMessage_1.ErrorMessage.EXTENSION_CLASS_NOT_EXIST, this._className, this._moduleName));
        }
        this._updateExtControlSourceMap(this._moduleName, extSource);
