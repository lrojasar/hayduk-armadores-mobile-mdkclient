...
var PushNotification = (function () {
    ...
    PushNotification.prototype.registerForPushNotification = function (applicationId, baseUrlString, deviceId) {
        ...
        return new Promise(function (resolve, reject) {
            _this.pushNotificationBridge.registerForPushNotificationResolveReject(applicationId, baseUrl, deviceId, function (id) { resolve(id); }, function (code, message, error) { reject(error); });
        });
    };
