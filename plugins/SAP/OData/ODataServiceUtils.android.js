...
var ODataServiceUtils = (function () {
    ...
    ODataServiceUtils.convert = function (value, type) {
    ...
    ODataServiceUtils.convertString = function (value) {
        ...
        if (typeof value === 'string') {
            ...
            throw new Error(ErrorMessage_1.ErrorMessage.ODATA_CONVERT_TO_STRING_FAILED);
        }
    };
    ODataServiceUtils.convertInteger = function (value) {
        ...
        if (value instanceof java.math.BigInteger) {
            ...
            throw new Error(ErrorMessage_1.ErrorMessage.ODATA_CONVERT_TO_INTEGER_FAILED);
        }
    };
    ODataServiceUtils.convertByte = function (value) {
        ...
        if (typeof value === 'number') {
            ...
            throw new Error(ErrorMessage_1.ErrorMessage.ODATA_CONVERT_TO_BYTE_FAILED);
        }
        if (returnValue < -128 || returnValue > 127) {
            throw new Error(ErrorMessage_1.ErrorMessage.ODATA_NUMBER_TO_SIGNED_BYTE_OVERFLOWED);
        }
    ...
    ODataServiceUtils.convertBool = function (value) {
        ...
        if (typeof value === 'boolean') {
            ...
            throw new Error(ErrorMessage_1.ErrorMessage.ODATA_CONVERT_TO_BOOLEAN_FAILED);
        }
    };
    ODataServiceUtils.convertChar = function (value) {
        ...
        if (typeof value === 'number') {
            ...
            throw new Error(ErrorMessage_1.ErrorMessage.ODATA_CONVERT_TO_CHAR_FAILED);
        }
    };
    ODataServiceUtils.convertDecimal = function (value) {
        ...
        if (value instanceof java.math.BigDecimal) {
            ...
            throw new Error(ErrorMessage_1.ErrorMessage.ODATA_CONVERT_TO_DECIMAL_FAILED);
        }
    };
    ODataServiceUtils.convertDouble = function (value) {
        ...
        if (typeof value === 'number') {
            ...
            throw new Error(ErrorMessage_1.ErrorMessage.ODATA_CONVERT_TO_DOUBLE_FAILED);
        }
    };
    ODataServiceUtils.convertFloat = function (value) {
        ...
        if (typeof value === 'number') {
            ...
            throw new Error(ErrorMessage_1.ErrorMessage.ODATA_CONVERT_TO_FLOAT_FAILED);
        }
    };
    ODataServiceUtils.convertInt = function (value) {
        ...
        if (typeof value === 'number') {
            ...
            throw new Error(ErrorMessage_1.ErrorMessage.ODATA_CONVERT_TO_INT_FAILED);
        }
    };
    ODataServiceUtils.convertShort = function (value) {
        ...
        if (typeof value === 'number') {
            ...
            throw new Error(ErrorMessage_1.ErrorMessage.ODATA_CONVERT_TO_SHORT_FAILED);
        }
    };
    ODataServiceUtils.convertLong = function (value) {
        ...
        if (typeof value === 'number') {
            ...
            throw new Error(ErrorMessage_1.ErrorMessage.ODATA_CONVERT_TO_LONG_FAILED);
        }
    };
    ODataServiceUtils.convertUnsignedByte = function (value) {
        ...
        if (typeof value === 'number') {
            ...
            throw new Error(ErrorMessage_1.ErrorMessage.ODATA_CONVERT_TO_UNSIGNEDBYTE_FAILED);
        }
        if (returnValue > 255) {
            throw new Error(ErrorMessage_1.ErrorMessage.ODATA_NUMBER_TO_BYTE_OVERFLOW);
        }
        if (returnValue < 0) {
            throw new Error(ErrorMessage_1.ErrorMessage.ODATA_NEGATIVE_VALUES_NOT_ALLOWED);
        }
    ...
    ODataServiceUtils.convertLocalDateTime = function (value) {
        ...
        if (typeof value === 'string') {
            ...
            if (utcDate) {
                ...
                throw new Error(ErrorMessage_1.ErrorMessage.format(ErrorMessage_1.ErrorMessage.ODATA_CONVERT_STRING_TO_LOCALDATETIME_FAILED, value));
            }
        }
        if (value instanceof Date) {
            return this.localDateTimeFrom(value, ODataServiceProvider_1.ODataServiceProvider.getServiceTimeZoneAbbreviation());
        }
        throw new Error(ErrorMessage_1.ErrorMessage.ODATA_CONVERT_TO_LOCALDATETIME_FAILED);
    };
    ODataServiceUtils.convertGlobalDateTime = function (value) {
        ...
        if (typeof value === 'string') {
            ...
            if (utcDate) {
                ...
                throw new Error(ErrorMessage_1.ErrorMessage.format(ErrorMessage_1.ErrorMessage.ODATA_CONVERT_STRING_TO_GLOBALDATETIME_FAILED, value));
            }
        }
        if (value instanceof Date) {
            return this.globalDateTimeFrom(value);
        }
        throw new Error(ErrorMessage_1.ErrorMessage.ODATA_CONVERT_TO_GLOBALDATETIME_FAILED);
    };
    ODataServiceUtils.convertLocalDate = function (value) {
        ...
        if (typeof value === 'string') {
            ...
            if (utcDate) {
                ...
                throw new Error(ErrorMessage_1.ErrorMessage.format(ErrorMessage_1.ErrorMessage.ODATA_CONVERT_STRING_TO_LOCALDATE_FAILED, value));
            }
        }
        if (value instanceof Date) {
            return this.localDateFrom(value, ODataServiceProvider_1.ODataServiceProvider.getServiceTimeZoneAbbreviation());
        }
        throw new Error(ErrorMessage_1.ErrorMessage.ODATA_CONVERT_TO_LOCALDATE_FAILED);
    };
    ODataServiceUtils.convertLocalTime = function (value) {
        ...
        if (typeof value === 'string') {
            ...
            if (utcDate) {
                ...
                throw new Error(ErrorMessage_1.ErrorMessage.format(ErrorMessage_1.ErrorMessage.ODATA_CONVERT_STRING_TO_LOCALTIME_FAILED, value));
            }
        }
        if (value instanceof Date) {
            return this.localTimeFrom(value, ODataServiceProvider_1.ODataServiceProvider.getServiceTimeZoneAbbreviation());
        }
        throw new Error(ErrorMessage_1.ErrorMessage.ODATA_CONVERT_TO_LOCALTIME_FAILED);
    };
    ODataServiceUtils.convertGUID = function (value) {
        ...
        if (typeof value === 'string') {
            try {
                ...
                throw new Error(ErrorMessage_1.ErrorMessage.ODATA_CONVERT_TO_GUID_FAILED);
            }
        }
    };
    ODataServiceUtils.convertDayTimeDuration = function (value) {
        ...
        if (typeof value === 'string') {
            try {
                ...
                throw new Error(ErrorMessage_1.ErrorMessage.ODATA_CONVERT_TO_DAYTIMEDURATION_FAILED);
            }
        }
    };
