...
export class ODataServiceUtils {
  ...
  public static convert(value: any, type: number): any {
  ...
  private static convertString(value: any): any {
    ...
    if (typeof value === 'string') {
      ...
      throw new Error(ErrorMessage.ODATA_CONVERT_TO_STRING_FAILED);
    }
  }
  ...
  private static convertInteger(value: any): any {
    ...
    if (value instanceof java.math.BigInteger) {
      ...
      throw new Error(ErrorMessage.ODATA_CONVERT_TO_INTEGER_FAILED);
    }
  }
  ...
  private static convertByte(value: any): any {
    ...
    if (typeof value === 'number') {
      ...
      throw new Error(ErrorMessage.ODATA_CONVERT_TO_BYTE_FAILED);
    }
    if (returnValue < -128 || returnValue > 127) {
      throw new Error(ErrorMessage.ODATA_NUMBER_TO_SIGNED_BYTE_OVERFLOWED);
    }
  ...
  private static convertBool(value: any): any {
    ...
    if (typeof value === 'boolean') {
      ...
      throw new Error(ErrorMessage.ODATA_CONVERT_TO_BOOLEAN_FAILED);
    }
  }
  ...
  private static convertChar(value: any): any {
    ...
    if (typeof value === 'number') {
      ...
      throw new Error(ErrorMessage.ODATA_CONVERT_TO_CHAR_FAILED);
    }
  }
  ...
  private static convertDecimal(value: any): any {
    ...
    if (value instanceof java.math.BigDecimal) {
      ...
      throw new Error(ErrorMessage.ODATA_CONVERT_TO_DECIMAL_FAILED);
    }
  }
  ...
  private static convertDouble(value: any): any {
    ...
    if (typeof value === 'number') {
      ...
      throw new Error(ErrorMessage.ODATA_CONVERT_TO_DOUBLE_FAILED);
    }
  }
  ...
  private static convertFloat(value: any): any {
    ...
    if (typeof value === 'number') {
      ...
      throw new Error(ErrorMessage.ODATA_CONVERT_TO_FLOAT_FAILED);
    }
  }
  ...
  private static convertInt(value: any): any {
    ...
    if (typeof value === 'number') {
      ...
      throw new Error(ErrorMessage.ODATA_CONVERT_TO_INT_FAILED);
    }
  }
  ...
  private static convertShort(value: any): any {
    ...
    if (typeof value === 'number') {
      ...
      throw new Error(ErrorMessage.ODATA_CONVERT_TO_SHORT_FAILED);
    }
  }
  ...
  private static convertLong(value: any): any {
    ...
    if (typeof value === 'number') {
      ...
      throw new Error(ErrorMessage.ODATA_CONVERT_TO_LONG_FAILED);
    }
  }
  ...
  private static convertUnsignedByte(value: any): any {
    ...
    if (typeof value === 'number') {
      ...
      throw new Error(ErrorMessage.ODATA_CONVERT_TO_UNSIGNEDBYTE_FAILED);
    }
    if (returnValue > 255) {
      throw new Error(ErrorMessage.ODATA_NUMBER_TO_BYTE_OVERFLOW);
    }

    if (returnValue < 0) {
      throw new Error(ErrorMessage.ODATA_NEGATIVE_VALUES_NOT_ALLOWED);
    }
  ...
  private static convertLocalDateTime(value: any): any {
    ...
    if (typeof value === 'string') {
      ...
      if (utcDate) {
        ...
        throw new Error(ErrorMessage.format(ErrorMessage.ODATA_CONVERT_STRING_TO_LOCALDATETIME_FAILED, value));
      }
    }
    ...
    throw new Error(ErrorMessage.ODATA_CONVERT_TO_LOCALDATETIME_FAILED);
  }
  ...
  private static convertGlobalDateTime(value: any): any {
    ...
    if (typeof value === 'string') {
      ...
      if (utcDate) {
        ...
        throw new Error(ErrorMessage.format(ErrorMessage.ODATA_CONVERT_STRING_TO_GLOBALDATETIME_FAILED, value));
      }
    }
    ...
    throw new Error(ErrorMessage.ODATA_CONVERT_TO_GLOBALDATETIME_FAILED);
  }
  ...
  private static convertLocalDate(value: any): any {
    ...
    if (typeof value === 'string') {
      ...
      if (utcDate) {
        ...
        throw new Error(ErrorMessage.format(ErrorMessage.ODATA_CONVERT_STRING_TO_LOCALDATE_FAILED, value));
      }
    }
    ...
    throw new Error(ErrorMessage.ODATA_CONVERT_TO_LOCALDATE_FAILED);
  }
  ...
  private static convertLocalTime(value: any): any {
    ...
    if (typeof value === 'string') {
      ...
      if (utcDate) {
        ...
        throw new Error(ErrorMessage.format(ErrorMessage.ODATA_CONVERT_STRING_TO_LOCALTIME_FAILED, value));
      }
    }
    ...
    throw new Error(ErrorMessage.ODATA_CONVERT_TO_LOCALTIME_FAILED);
  }
  ...
  private static convertGUID(value: any): any {
    ...
    if (typeof value === 'string') {
      try {
        ...
        throw new Error(ErrorMessage.ODATA_CONVERT_TO_GUID_FAILED);
      }
    }
  }
  ...
  private static convertDayTimeDuration(value: any): any {
    ...
    if (typeof value === 'string') {
      try {
        ...
        throw new Error(ErrorMessage.ODATA_CONVERT_TO_DAYTIMEDURATION_FAILED);
      }
    }
  }
